  ...
  <div class="row">
    <div class="col-md-8" id="main" data-id="{{ $highlight[0]->id }}" data-ip="{{ User::user_ip() }}">
      ...
      <video class="video-js vjs-16-9 vjs-big-play-centered" preload="auto"
        ...
        <source src="https://dl.dropboxusercontent.com/s/agsjz5lnv95wjhl/Arsenal%20vs%20Manchester%20United%201-3%20All%20Goals%20%26%20Extended%20Highlights%20-%20Premier%20League%20-%2002-12-2017%20HD.m4v" type="video/mp4">
      </video>
      <br><br>
